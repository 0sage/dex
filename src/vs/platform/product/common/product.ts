...
// _VSCODE environment
	...
	// Inherited from the VSCodium patch set. Hygiene counts lint warnings as
	// errors, and the renames below put this file in its path; the `any` here is
	// left as-is rather than retyping inherited runtime code to please the hook.
