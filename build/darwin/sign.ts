...
function getEntitlementsForFile(filePath: string): string {
	if (filePath.includes(' Helper (GPU).app')) {
		return path.join(import.meta.dirname, 'entitlements', 'helper-gpu-entitlements.plist');
	} else if (filePath.includes(' Helper (Renderer).app')) {
		return path.join(import.meta.dirname, 'entitlements', 'helper-renderer-entitlements.plist');
	} else if (filePath.includes(' Helper (Plugin).app')) {
		return path.join(import.meta.dirname, 'entitlements', 'helper-plugin-entitlements.plist');
	} else if (filePath.includes(' Helper.app')) {
		return path.join(import.meta.dirname, 'entitlements', 'helper-entitlements.plist');
	}
	return path.join(import.meta.dirname, 'entitlements', 'app-entitlements.plist');
}
